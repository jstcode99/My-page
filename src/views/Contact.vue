<template>
  <div>
    <Parallax :img="img" id="contact" title="Contacto"></Parallax>
    <div class="typewriter">
      <p class="typing">!Bienvenido, Listo para explorar mi portafolio, contáctame aquí!</p>
    </div>
    <b-form
      class="form-contac p-5"
...
<script>
import Parallax from '../components/Subpage/Parallax/Parallax'
...
export default {
  ...
  data() {
    return {
      img: require('@/assets/img/animations/parallax-contact.jpg'),
      btnStaus: false,
      btnStaus2: false,
